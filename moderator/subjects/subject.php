        ...
        <div class="card">
            ...
            <div class="card-header">
                <div class="row">
                    ...
                    <div class="col-12 col-sm-6">
                        <a href="?page=subjects&action=add" class="btn btn-success float-md-right"><i class="fas fa-fw fa-plus-circle"></i> Add New Subjects</a>
                    </div>
                </div>
            </div>
            <!-- End Header Table  -->
                    ...
                    <tbody>
                        ...
                        foreach ($subjects as $subject) : ?>
                            <tr>
                                ...
                                <td>
                                    <a class="badge badge-warning" href="?page=subjects&action=edit&id=<?= $subject["id"]; ?>"><i class="fas fa-edit"></i></a>
