  ...
  <div class="col-12 col-md-6 p-4 shadow">
    ...
    <form action="" method="POST" enctype="multipart/form-data">
      ...
      <div class="form-group">
        ...
        <input type="hidden" class="form-control" name="oldemail" id="email" value="<?= $user["email"]; ?>" required>
      </div>
      ...
      <div class="form-group">
        ...
        <input type="hidden" class="form-control" name="oldusername" id="username" value="<?= $user["username"]; ?>" required>
      </div>
