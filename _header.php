...
<head>
    ...
    <link href="../_asset/vendor/fontawesome-free/css/all.min.css" rel="stylesheet" type="text/css">
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gray-900 sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Nav Item - Pages Collapse Teachers -->
            <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="true" aria-controls="collapseTwo">
                    <i class="fas fa-fw fa-cog"></i>
                    <span>Teachers Modify</span>
                </a>
            ...
            <!-- End Nav Item - Pages Collapse Teacher -->

            <!-- Nav Item - Pages Collapse Subjects -->
            <li class="nav-item">
            ...
            <!-- End Nav Item - Pages Collapse Subjects -->

            <!-- Nav Item - Pages Collapse Students -->
            <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                    <i class="fas fa-fw fa-cog"></i>
                    <span>Students Modify</span>
                </a>
            ...
            <!-- End Nav Item - Pages Collapse Students -->
                    ...
                    <ul class="navbar-nav ml-auto">
                            ...
                            <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="messagesDropdown">
                                ...
                                <a class="dropdown-item d-flex align-items-center" href="#">
                                    <div class="dropdown-list-image mr-3">
                                        <img class="rounded-circle" src="../_asset/img/undraw_profile_1.svg" alt="...">
                                ...
                                <a class="dropdown-item d-flex align-items-center" href="#">
                                    <div class="dropdown-list-image mr-3">
                                        <img class="rounded-circle" src="../_asset/img/undraw_profile_2.svg" alt="...">
                                ...
                                <a class="dropdown-item d-flex align-items-center" href="#">
                                    <div class="dropdown-list-image mr-3">
                                        <img class="rounded-circle" src="../_asset/img/undraw_profile_3.svg" alt="...">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                ...
                                <img class="img-profile rounded-circle" src="../_asset/img/undraw_profile.svg">
                            </a>
