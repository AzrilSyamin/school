        ...
        <div class="card">
            ...
            <div class="card-header">
                <div class="row">
                    ...
                    <div class="col-12 col-sm-6">
                        <a href="?page=students&action=add" class="btn btn-success float-md-right"><i class="fas fa-fw fa-plus-circle"></i> Add New Students</a>
                    </div>
                </div>
            </div>
            <!-- End Header Table  -->
                        ...
                        foreach ($students as $student) : ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a class="badge badge-warning" href="?page=students&action=edit&id=<?= $student["id"]; ?>"><i class="fas fa-edit"></i></i></a>
