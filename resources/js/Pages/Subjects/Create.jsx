        ...
        <AuthenticatedLayout title="Tambah Mata Pelajaran">
            ...
            <div className="max-w-2xl space-y-6">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold text-slate-900 dark:text-white">Tambah Mata Pelajaran Baharu</h1>
                        <p className="mt-1 text-sm text-slate-500 dark:text-slate-400">Daftar mata pelajaran baharu dan pilih kursus yang berkaitan.</p>
                    </div>
                </div>
                    ...
                    <form onSubmit={submit} className="space-y-6">
                        <div>
                            ...
                            <input
                                ...
                                placeholder="Contoh: Basic Linux"
                            />
