...
export default function Create({ lecturers }) {
    ...
    return (
        <AuthenticatedLayout title="Tambah Kursus">
            ...
            <div className="max-w-2xl space-y-6">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold text-slate-900 dark:text-white">Tambah Kursus Baharu</h1>
                        <p className="mt-1 text-sm text-slate-500 dark:text-slate-400">Daftar kursus pengajian baharu dan lantik pengurus kursus.</p>
                    </div>
                </div>
                    ...
                    <form onSubmit={submit} className="space-y-6">
                        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
                            ...
                            <div className="sm:col-span-2">
                                ...
                                <input
                                    ...
                                    className={inputClass}
                                    placeholder="cth: Diploma Teknologi Maklumat"
                                />
                        ...
                        <div>
                            ...
                            <p className="mt-2 text-[11px] text-slate-500 italic">
                                * Pengurus kursus akan mempunyai akses untuk mengurus subjek dan pelajar di bawah kursus ini.
                            </p>
