...
export default function Create({ classrooms }) {
    ...
    return (
        <AuthenticatedLayout title="Tambah Pelajar">
            ...
            <div className="max-w-2xl space-y-6">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold text-slate-900 dark:text-white">Tambah Pelajar Baharu</h1>
                        <p className="mt-1 text-sm text-slate-500 dark:text-slate-400">Daftar maklumat pelajar ke dalam sistem.</p>
                    </div>
                </div>
