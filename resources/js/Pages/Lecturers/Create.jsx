...
export default function Create() {
    ...
    return (
        <AuthenticatedLayout title="Daftar Pensyarah">
            <Head title="Daftar Pensyarah" />
            ...
            <div className="max-w-4xl space-y-6">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold text-slate-900 dark:text-white">Pendaftaran Pensyarah Baharu</h1>
                        <p className="mt-1 text-sm text-slate-500 dark:text-slate-400">Masukkan maklumat peribadi dan akaun pensyarah.</p>
                    </div>
                </div>
