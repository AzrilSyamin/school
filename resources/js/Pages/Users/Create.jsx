...
export default function Create({ roles, classrooms }) {
        ...
        <AuthenticatedLayout title="Tambah Pengguna">
            ...
            <div className="max-w-4xl space-y-6">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold text-slate-900 dark:text-white">Daftar Pengguna Baharu</h1>
                        <p className="mt-1 text-sm text-slate-500 dark:text-slate-400">Masukkan maklumat akaun pengguna sistem.</p>
                    </div>
                </div>
                    ...
                    <form onSubmit={submit} className="space-y-8">
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                                ...
                                <div>
                                    <label htmlFor="picture" className={labelClass}>Gambar Profil</label>
                                    <input
                                        id="picture"
                                        type="file"
                        ...
                        <div className="space-y-6 pt-6 border-t border-slate-200 dark:border-slate-200 dark:border-slate-800">
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                                ...
                                <div>
                                    <label htmlFor="password" className={labelClass}>Kata Laluan</label>
                                    <input
                                        id="password"
                                        type="password"
                                        value={data.password}
                                ...
                                <div>
                                    <label htmlFor="password_confirmation" className={labelClass}>Sahkan Kata Laluan</label>
                                    <input
