...
<head>
    ...
    <title>Detail Of Students | Sekolah</title>
            ...
            <div class="sidebar-heading">
                ...
                <div id="collapseOne" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="add.php">Add Students</a>
                        <a class="collapse-item" href="edit.php">Edit Students</a>
                        <a class="collapse-item" href="del.php">Delete Students</a>
                    </div>
                </div>
                </li>
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="add.php">Add Teachers</a>
                        <a class="collapse-item" href="edit.php">Edit Teachers</a>
                        <a class="collapse-item" href="del.php">Delete Teachers</a>
                    </div>
                </div>
                </li>
